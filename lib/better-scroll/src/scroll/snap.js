...
export function snapMixin(BScroll) {
  BScroll.prototype._initSnap = function () {
    ...
    this.on('refresh', () => {
      ...
      this._goToPage(this.currentPage.pageX !== undefined ? this.currentPage.pageX : initPageX, this.currentPage.pageY || initPageY, 0)
  ...
  BScroll.prototype._checkSnapLoop = function () {
    const snap = this.options.snap
    // console.log('inner', this.options.snap.loop, this.options.test)
